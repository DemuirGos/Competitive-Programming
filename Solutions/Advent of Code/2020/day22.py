...
#            return (0,deck1)
#        else:
#            if any([len(deck) < deck[0] for deck in [deck1,deck2]]):
#                if deck1[0] > deck2[0]:
#                    return playGame(deck1[1:] + [deck1[0], deck2[0]], deck2[1:], [memo[0] + [deck1],memo[0] + [deck2]])
#                else:
#                    return playGame(deck1[1:], deck2[1:] + [deck2[0], deck1[0]], [memo[0] + [deck1],memo[0] + [deck2]])
#            else:
#                subGame = playGame(deck1[1 : 1 + deck1[0]], deck2[1 : 1 + deck2[0]],[[]]*2)
#                if subGame[0] == 0:
#                    return playGame(deck1[1:] + [deck1[0], deck2[0]], deck2[1:], [memo[0] + [deck1],memo[0] + [deck2]])
#                else:
#                    return playGame(deck1[1:], deck2[1:] + [deck2[0], deck1[0]], [memo[0] + [deck1],memo[0] + [deck2]])
